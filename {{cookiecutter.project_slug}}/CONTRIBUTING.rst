...
2. Clone your fork locally::
    ...
    $ git clone URL/{{ cookiecutter.project_slug }}.git

3. Install your local copy into a conda env. Assuming you have Miniconda or
Conda installed, this is how you set up your fork for local
development::

    $ conda create -f  {{ cookiecutter.project_slug }}
